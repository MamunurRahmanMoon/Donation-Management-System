...
if(isset($_POST['upload_image_btn'])){
        ...
        if(move_uploaded_file($src, $des)){
            ...
            header("location: ../views/requester.php?err=imageSuccess");
        }else{
            header("location: editRequester.php?err=imageFailed");
        }
    }
    ...
    if(isset($_POST['update_userProfile'])){
        ...
        if($status){
            ...
            header("location: ../views/editRequester.php?err=infoFailed");
        }
    }
