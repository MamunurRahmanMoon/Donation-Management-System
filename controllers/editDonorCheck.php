...
if(isset($_POST['upload_image_btn'])){
        ...
        if(move_uploaded_file($src, $des)){
            ...
            header("location: ../views/Donor.php?err=imageSuccess");
        }else{
            header("location: editDonor.php?err=imageFailed");
        }
    }
    ...
    if(isset($_POST['update_userProfile'])){
        ...
        if($status){
            header("location: ../views/donor.php?err=infoSuccess");
        }
        else{
            header("location: ../views/editDonor.php?err=infoFailed");
        }
    }
