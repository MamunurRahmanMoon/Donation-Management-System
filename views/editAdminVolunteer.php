...
<body>
    <div class='adminLogIn'>
        <div>
            <div class="extra-gap">
                <a class="dashboard_btn" href="adminVolunteer.php">Back To Dashboard</a>
            </div>
            
            <form name="userForm"  action="../controllers/editAdminVolunteerCheck.php" method="POST">
                    <fieldset>
                        <legend>Donor Profile</legend>
                        <div>
                            <table border=1>
                                <?php
                                        $ID = base64_decode($_GET['volunteerID']);
                                        
                                        // $_SESSION['updateDonor'] = true;

                                        require_once('../models/volunteerModel.php');
                                        $result = displayAdminVolunteerProfile($ID);
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php 
                                            session_start();
                                            $_SESSION['currentAdminVolunteerID'] = $data['ID'];
                                            $id = $_SESSION['currentAdminVolunteerID'];
                                            // echo $id;
                                        ?>
                                     </td>
                                </tr>
                                <tr>
                                    <td>Fullname</td>
                                    <td> <input name="displayFullname" type="text" value="<?= $data['fullname']?>"> </td>
                                </tr>
                                <tr>
                                    <td>Username</td>
                                    <td> <input name="displayUsername" type="text" value="<?= $data['username']?>">
                                    <?php
                                        $_SESSION['currentAdminVolunteerUsername'] = $data['username'];
                                    ?> 
                                </td>
                                </tr>
                                <tr>
        ...
        <div class="profile-image-area">
            <form method="POST" action="../controllers/editAdminVolunteerCheck.php" enctype="multipart/form-data">
                <div class="inside-profile-image">
                    
                    <div>
                        <img class="profile-image" src="../assets/images/uploads/volunteerUpload/<?php
                            if($data['image'] == null){
                                echo "default.png";
                            }else{
                                echo "{$data['image']}";
                    ...
                    <div class="image-upload-button-area">
                        <input name="upload_image_volunteer" type="file" id="">
