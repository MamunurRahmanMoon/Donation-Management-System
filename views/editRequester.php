...
<body>
    <div class='adminLogIn'>
        <div>
            <div class="extra-gap">
                <a class="dashboard_btn" href="requester.php">Back To Dashboard</a>
            </div>
            <form name="userForm"  action="../controllers/editRequesterCheck.php" method="POST">
                    <fieldset>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php 
                                            ...
                                            $id = $_SESSION['currentAdminRequesterID'];
                                            // echo $id;
                                        ?>
                                     </td>
                                </tr>
        ...
        <div class="profile-image-area">
            <form method="POST" action="../controllers/editRequesterCheck.php" enctype="multipart/form-data">
